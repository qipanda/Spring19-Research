...
if __name__ == "__main__":
    ...
    with open("../Data/ABC-News/abcnews-date-text.csv", "r") as raw_data:
    ...
    # Start the listener
    writefilepath = "../Data/ABC-News/abcnews-window-ctxt.txt"
    ...
    for idx, line in enumerate(lines):
        result = pool.apply_async(
            hp.writeWindowedTuple, (idx, line, queue, translator, countryforms))
